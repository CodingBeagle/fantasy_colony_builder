// Cargo will compile and execute build.rs before building the actual crate.
...
fn main() {
    ...
    // bindgen::Builder is the main entry point to bindgen. It lets you build up options for the resulting bindings.
    let bindings = bindgen::Builder::default()
        // I blocklist VkSurfaceKHR types, and VkInstance type.
        // These types are what is known as "Non-dispatchable" handle types, and are 64-bit integer types.
        // They are, for some reason, not properly handled by bindgen.
        ...
        .header("wrapper.h")
        // With the F argument, I add the directory to search for the header files for GLFW
    ...
    bindings
        ...
        .expect("Couldn't write GLFW bindings to binding.rs file!");
}